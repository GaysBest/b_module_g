...
client.on('message', message => {
    const swearWords = ["SG", "чифир","взлом", "ЧИФИР", "ВЗЛОМ", "соурсгеймс", "СОУРСГЕЙМС", "сорсгамес", "sgru", "SGRU", "взлома", "Chifir", "https://discord.gg/", "chifir", "4ифир", "4ifir", "Чифир", "покупной", "Покупной", "СГ", "СГРУ", "SGRU", "сгру", "Сгру", "ЧИФИР", "бекдор", "Бекдор", "Бэкдур", "Бэкдор", "бэкдур", "бекдур", "backdoor", "doorback", "discord.gg", "ПГЗ", "пгз", "PGZ", "pgz", "PROGAMESZET", "PROGAMES", "progameszet", "progames", "прогамесзет", "ПРОГАМЕСЗЕТ", "прогеймесзет", "ПРОГЕЙМЕСЗЕТ", "Пгз", "Pgz"];	
...
client.on('guildMemberRemove', member => {	
    ...
    fs.writeFile("./warnings.json", JSON.stringify(backrole), (err) => {
...
client.on('guildMemberAdd', member => {	
    if(backrole[member.id].backrole === "418829292160417793") {
